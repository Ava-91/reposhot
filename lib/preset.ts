...
export function decodePreset(value: string, themes: readonly string[], layouts: readonly string[], templates: readonly string[]): PresetConfig | null {
  try {
    ...
    return {
      ...
      metadata: {
        description: metadata.description!, language: metadata.language!, stars: metadata.stars!,
        forks: metadata.forks!, openIssues: metadata.openIssues!, owner: metadata.owner!,
        subtitle: cleanText(metadata.subtitle), footerText: cleanText(metadata.footerText),
        showGithubUrl: metadata.showGithubUrl!,
